...
> **1337 / 42 Piscine** · Concepts: loops, characters  
...
Master **ft_print_alphabet** and build intuition for: **loops, characters**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_print_alphabet` | Appears again in exams and later modules |
...
Implement **ft_print_alphabet** following the 42 subject for C00/ex01.

**Key concepts:** loops, characters
...
**ft_print_alphabet** — loops, characters. Understand the model, then the syntax.
