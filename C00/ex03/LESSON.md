...
> **1337 / 42 Piscine** · Concepts: digits, loops  
...
Master **ft_print_numbers** and build intuition for: **digits, loops**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_print_numbers` | Appears again in exams and later modules |
...
Implement **ft_print_numbers** following the 42 subject for C00/ex03.

**Key concepts:** digits, loops
...
**ft_print_numbers** — digits, loops. Understand the model, then the syntax.
