...
> **1337 / 42 Piscine** · Concepts: conditions, return values  
...
Master **ft_is_negative** and build intuition for: **conditions, return values**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_is_negative` | Appears again in exams and later modules |
...
Implement **ft_is_negative** following the 42 subject for C00/ex04.

**Key concepts:** conditions, return values
...
| Concepts | conditions, return values |
...
**ft_is_negative** — conditions, return values. Understand the model, then the syntax.
