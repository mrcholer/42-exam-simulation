...
> **1337 / 42 Piscine** · Concepts: nested loops, combinations  
...
Master **ft_print_comb** and build intuition for: **nested loops, combinations**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_print_comb` | Appears again in exams and later modules |
...
- [C00/README.md](../README.md) module index
- Relevant **Theory/** lessons (see module README)
- Previous exercises in **C00**

---

## The Problem

Implement **ft_print_comb** following the 42 subject for C00/ex05.

**Key concepts:** nested loops, combinations
...
| Concepts | nested loops, combinations |
...
**ft_print_comb** — nested loops, combinations. Understand the model, then the syntax.
