...
> **1337 / 42 Piscine** · Concepts: nested loops, pairs  
...
Master **ft_print_comb2** and build intuition for: **nested loops, pairs**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_print_comb2` | Appears again in exams and later modules |
...
Implement **ft_print_comb2** following the 42 subject for C00/ex06.

**Key concepts:** nested loops, pairs
...
**ft_print_comb2** — nested loops, pairs. Understand the model, then the syntax.
