...
> **1337 / 42 Piscine** · Concepts: integers, recursion, digits  
...
Master **ft_putnbr** and build intuition for: **integers, recursion, digits**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_putnbr` | Appears again in exams and later modules |
...
Implement **ft_putnbr** following the 42 subject for C00/ex07.

**Key concepts:** integers, recursion, digits
...
|------|-------|
| Function | `ft_putnbr` |
| Concepts | integers, recursion, digits |
...
**ft_putnbr** — integers, recursion, digits. Understand the model, then the syntax.
