...
> **1337 / 42 Piscine** · Concepts: recursion, combinations  
...
Master **ft_print_combn** and build intuition for: **recursion, combinations**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_print_combn` | Appears again in exams and later modules |
...
Implement **ft_print_combn** following the 42 subject for C00/ex08.

**Key concepts:** recursion, combinations
...
| Concepts | recursion, combinations |
...
**ft_print_combn** — recursion, combinations. Understand the model, then the syntax.
