...
> **1337 / 42 Piscine** · Concepts: multiple out-parameters  
...
Master **ft_div_mod** and build intuition for: **multiple out-parameters**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_div_mod` | Appears again in exams and later modules |
...
Implement **ft_div_mod** following the 42 subject for C01/ex03.

**Key concepts:** multiple out-parameters
...
├────────────┼─────────┼──────────────────────┤
│ (draw yours)│         │ multiple out-parameters │
└────────────┴─────────┴──────────────────────┘
```
...
|------|-------|
| Function | `ft_div_mod` |
| Concepts | multiple out-parameters |
...
**ft_div_mod** — multiple out-parameters. Understand the model, then the syntax.
