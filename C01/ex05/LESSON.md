...
> **1337 / 42 Piscine** · Concepts: string iteration  
...
Master **ft_putstr** and build intuition for: **string iteration**.
...
Implement **ft_putstr** following the 42 subject for C01/ex05.

**Key concepts:** string iteration
...
**ft_putstr** — string iteration. Understand the model, then the syntax.
