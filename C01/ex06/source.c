...
/*                                                                            */
/* ************************************************************************** */
/* C01/ex06 — ft_strlen — EDUCATIONAL REFERENCE */
/* Concepts: string length, pointers — STUDY, DO NOT SUBMIT */
...
/* ====================================================================== */
/*  THINK — string length, pointers                                                 */
/* ====================================================================== */

/* Implement ft_strlen per 42 subject — skeleton below */
/* TODO: Replace with your logic after tracing memory on paper */

/*
 * ft_strlen — string length, pointers
...
int main(void)
{
	write(1, "Demo: ft_strlen\n", 16);
	/* Call ft_strlen here after you understand the function above. */
	return (0);
}
