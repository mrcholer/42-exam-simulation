...
> **1337 / 42 Piscine** · Concepts: sorting, arrays  
...
Master **ft_sort_int_tab** and build intuition for: **sorting, arrays**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_sort_int_tab` | Appears again in exams and later modules |
...
Implement **ft_sort_int_tab** following the 42 subject for C01/ex08.

**Key concepts:** sorting, arrays
...
**ft_sort_int_tab** — sorting, arrays. Understand the model, then the syntax.
