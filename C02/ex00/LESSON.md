...
> **1337 / 42 Piscine** · Concepts: string copy  
...
Master **ft_strcpy** and build intuition for: **string copy**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_strcpy` | Appears again in exams and later modules |
...
Implement **ft_strcpy** following the 42 subject for C02/ex00.

**Key concepts:** string copy
...
**ft_strcpy** — string copy. Understand the model, then the syntax.
