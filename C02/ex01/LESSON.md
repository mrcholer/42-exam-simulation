...
> **1337 / 42 Piscine** · Concepts: bounded copy  
...
Master **ft_strncpy** and build intuition for: **bounded copy**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_strncpy` | Appears again in exams and later modules |
...
Implement **ft_strncpy** following the 42 subject for C02/ex01.

**Key concepts:** bounded copy
...
**ft_strncpy** — bounded copy. Understand the model, then the syntax.
