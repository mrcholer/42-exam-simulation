...
> **1337 / 42 Piscine** · Concepts: character tests  
...
Master **ft_str_is_alpha** and build intuition for: **character tests**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_str_is_alpha` | Appears again in exams and later modules |
...
Implement **ft_str_is_alpha** following the 42 subject for C02/ex02.

**Key concepts:** character tests
...
**ft_str_is_alpha** — character tests. Understand the model, then the syntax.
