...
> **1337 / 42 Piscine** · Concepts: digit tests  
...
Master **ft_str_is_numeric** and build intuition for: **digit tests**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_str_is_numeric` | Appears again in exams and later modules |
...
Implement **ft_str_is_numeric** following the 42 subject for C02/ex03.

**Key concepts:** digit tests
...
**ft_str_is_numeric** — digit tests. Understand the model, then the syntax.
