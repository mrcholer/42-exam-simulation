...
/*                                                                            */
/* ************************************************************************** */
/* C02/ex04 — ft_str_is_lowercase — EDUCATIONAL REFERENCE */
/* Concepts: case tests — STUDY, DO NOT SUBMIT */
...
/* Implement ft_str_is_lowercase per 42 subject — skeleton below */
/* TODO: Replace with your logic after tracing memory on paper */

/*
 * ft_str_is_lowercase — case tests
...
int main(void)
{
	write(1, "Demo: ft_str_is_lowercase\n", 26);
	/* Call ft_str_is_lowercase here after you understand the function above. */
	return (0);
}
