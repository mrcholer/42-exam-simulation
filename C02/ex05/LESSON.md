...
Master **ft_str_is_uppercase** and build intuition for: **case tests**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_str_is_uppercase` | Appears again in exams and later modules |
...
Implement **ft_str_is_uppercase** following the 42 subject for C02/ex05.
...
**ft_str_is_uppercase** — case tests. Understand the model, then the syntax.
