# C02/ex06 — ft_str_is_printable

> **1337 / 42 Piscine** · Concepts: printable range  
...
Master **ft_str_is_printable** and build intuition for: **printable range**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_str_is_printable` | Appears again in exams and later modules |
...
Implement **ft_str_is_printable** following the 42 subject for C02/ex06.

**Key concepts:** printable range
...
**ft_str_is_printable** — printable range. Understand the model, then the syntax.
