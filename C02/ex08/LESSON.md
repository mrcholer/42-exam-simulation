# C02/ex08 — ft_strlowcase

> **1337 / 42 Piscine** · Concepts: lowercase conversion  
...
Master **ft_strlowcase** and build intuition for: **lowercase conversion**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_strlowcase` | Appears again in exams and later modules |
...
Implement **ft_strlowcase** following the 42 subject for C02/ex08.

**Key concepts:** lowercase conversion
...
├────────────┼─────────┼──────────────────────┤
│ (draw yours)│         │ lowercase conversion │
└────────────┴─────────┴──────────────────────┘
```
...
**ft_strlowcase** — lowercase conversion. Understand the model, then the syntax.
