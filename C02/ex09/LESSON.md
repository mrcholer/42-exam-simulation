...
> **1337 / 42 Piscine** · Concepts: capitalize words  
...
Master **ft_strcapitalize** and build intuition for: **capitalize words**.
...
Implement **ft_strcapitalize** following the 42 subject for C02/ex09.

**Key concepts:** capitalize words
...
**ft_strcapitalize** — capitalize words. Understand the model, then the syntax.
