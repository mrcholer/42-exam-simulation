# C02/ex12 — ft_strcapitalize advanced

> **1337 / 42 Piscine** · Concepts: string parsing  
...
Master **ft_strcapitalize advanced** and build intuition for: **string parsing**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_strcapitalize` | Appears again in exams and later modules |
...
Implement **ft_strcapitalize advanced** following the 42 subject for C02/ex12.

**Key concepts:** string parsing
...
**ft_strcapitalize advanced** — string parsing. Understand the model, then the syntax.
