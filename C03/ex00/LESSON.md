...
> **1337 / 42 Piscine** · Concepts: string compare  
...
Master **ft_strcmp** and build intuition for: **string compare**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_strcmp` | Appears again in exams and later modules |
...
Implement **ft_strcmp** following the 42 subject for C03/ex00.

**Key concepts:** string compare
...
**ft_strcmp** — string compare. Understand the model, then the syntax.
