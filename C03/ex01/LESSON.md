...
> **1337 / 42 Piscine** · Concepts: bounded compare  
...
Master **ft_strncmp** and build intuition for: **bounded compare**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_strncmp` | Appears again in exams and later modules |
...
Implement **ft_strncmp** following the 42 subject for C03/ex01.

**Key concepts:** bounded compare
...
**ft_strncmp** — bounded compare. Understand the model, then the syntax.
