...
> **1337 / 42 Piscine** · Concepts: string concat  
...
Master **ft_strcat** and build intuition for: **string concat**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_strcat` | Appears again in exams and later modules |
...
Implement **ft_strcat** following the 42 subject for C03/ex02.

**Key concepts:** string concat
...
**ft_strcat** — string concat. Understand the model, then the syntax.
