...
/*                                                                            */
/* ************************************************************************** */
/* C03/ex03 — ft_strncat — EDUCATIONAL REFERENCE */
/* Concepts: bounded concat — STUDY, DO NOT SUBMIT */
...
/* ====================================================================== */
/*  THINK — bounded concat                                                 */
/* ====================================================================== */

/* Implement ft_strncat per 42 subject — skeleton below */
/* TODO: Replace with your logic after tracing memory on paper */

/*
 * ft_strncat — bounded concat
...
int main(void)
{
	write(1, "Demo: ft_strncat\n", 17);
	/* Call ft_strncat here after you understand the function above. */
	return (0);
}
