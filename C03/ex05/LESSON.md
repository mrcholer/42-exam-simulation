# C03/ex05 — ft_strtoupper/lowercase

> **1337 / 42 Piscine** · Concepts: case conversion  
...
Master **ft_strtoupper/lowercase** and build intuition for: **case conversion**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_strtoupper` | Appears again in exams and later modules |
...
Implement **ft_strtoupper/lowercase** following the 42 subject for C03/ex05.

**Key concepts:** case conversion
...
**ft_strtoupper/lowercase** — case conversion. Understand the model, then the syntax.
