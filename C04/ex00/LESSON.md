...
> **1337 / 42 Piscine** · Concepts: string length  
...
Master **ft_strlen** and build intuition for: **string length**.
...
Implement **ft_strlen** following the 42 subject for C04/ex00.

**Key concepts:** string length
...
**ft_strlen** — string length. Understand the model, then the syntax.
