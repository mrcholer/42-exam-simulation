...
> **1337 / 42 Piscine** · Concepts: print string  
...
Master **ft_putstr** and build intuition for: **print string**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_putstr` | Appears again in exams and later modules |
...
Implement **ft_putstr** following the 42 subject for C04/ex01.

**Key concepts:** print string
...
**ft_putstr** — print string. Understand the model, then the syntax.
