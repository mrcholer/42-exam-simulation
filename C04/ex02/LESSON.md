...
> **1337 / 42 Piscine** · Concepts: print number  
...
Master **ft_putnbr** and build intuition for: **print number**.
...
- [C04/README.md](../README.md) module index
- Relevant **Theory/** lessons (see module README)
- Previous exercises in **C04**

---

## The Problem

Implement **ft_putnbr** following the 42 subject for C04/ex02.

**Key concepts:** print number
...
**ft_putnbr** — print number. Understand the model, then the syntax.
