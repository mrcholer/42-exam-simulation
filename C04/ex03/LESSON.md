...
> **1337 / 42 Piscine** · Concepts: string to int  
...
Master **ft_atoi** and build intuition for: **string to int**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_atoi` | Appears again in exams and later modules |
...
Implement **ft_atoi** following the 42 subject for C04/ex03.

**Key concepts:** string to int
...
**ft_atoi** — string to int. Understand the model, then the syntax.
