...
> **1337 / 42 Piscine** · Concepts: loops, factorial  
...
Master **ft_iterative_factorial** and build intuition for: **loops, factorial**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_iterative_factorial` | Appears again in exams and later modules |
...
Implement **ft_iterative_factorial** following the 42 subject for C05/ex00.

**Key concepts:** loops, factorial
...
**ft_iterative_factorial** — loops, factorial. Understand the model, then the syntax.
