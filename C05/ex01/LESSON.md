...
> **1337 / 42 Piscine** · Concepts: recursion  
...
Master **ft_recursive_factorial** and build intuition for: **recursion**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_recursive_factorial` | Appears again in exams and later modules |
...
Implement **ft_recursive_factorial** following the 42 subject for C05/ex01.
...
**ft_recursive_factorial** — recursion. Understand the model, then the syntax.
