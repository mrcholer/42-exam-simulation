...
> **1337 / 42 Piscine** · Concepts: exponentiation  
...
Master **ft_iterative_power** and build intuition for: **exponentiation**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_iterative_power` | Appears again in exams and later modules |
...
Implement **ft_iterative_power** following the 42 subject for C05/ex02.

**Key concepts:** exponentiation
...
**ft_iterative_power** — exponentiation. Understand the model, then the syntax.
