...
> **1337 / 42 Piscine** · Concepts: recursive power  
...
Master **ft_recursive_power** and build intuition for: **recursive power**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_recursive_power` | Appears again in exams and later modules |
...
- [C05/README.md](../README.md) module index
- Relevant **Theory/** lessons (see module README)
- Previous exercises in **C05**

---

## The Problem

Implement **ft_recursive_power** following the 42 subject for C05/ex03.

**Key concepts:** recursive power
...
**ft_recursive_power** — recursive power. Understand the model, then the syntax.
