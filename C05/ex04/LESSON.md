# C05/ex04 — ft_fibonacci

> **1337 / 42 Piscine** · Concepts: fibonacci sequence  
...
Master **ft_fibonacci** and build intuition for: **fibonacci sequence**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_fibonacci` | Appears again in exams and later modules |
...
Implement **ft_fibonacci** following the 42 subject for C05/ex04.

**Key concepts:** fibonacci sequence
...
**ft_fibonacci** — fibonacci sequence. Understand the model, then the syntax.
