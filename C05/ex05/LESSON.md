...
> **1337 / 42 Piscine** · Concepts: square root  
...
Master **ft_sqrt** and build intuition for: **square root**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_sqrt` | Appears again in exams and later modules |
...
Implement **ft_sqrt** following the 42 subject for C05/ex05.
...
**ft_sqrt** — square root. Understand the model, then the syntax.
