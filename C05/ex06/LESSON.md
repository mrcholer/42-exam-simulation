# C05/ex06 — ft_is_prime

> **1337 / 42 Piscine** · Concepts: prime detection  
...
Master **ft_is_prime** and build intuition for: **prime detection**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_is_prime` | Appears again in exams and later modules |
...
Implement **ft_is_prime** following the 42 subject for C05/ex06.

**Key concepts:** prime detection
...
**ft_is_prime** — prime detection. Understand the model, then the syntax.
