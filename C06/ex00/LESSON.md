...
> **1337 / 42 Piscine** · Concepts: argv, program name  
...
Master **ft_print_program_name** and build intuition for: **argv, program name**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_print_program_name` | Appears again in exams and later modules |
...
Implement **ft_print_program_name** following the 42 subject for C06/ex00.

**Key concepts:** argv, program name
...
**ft_print_program_name** — argv, program name. Understand the model, then the syntax.
