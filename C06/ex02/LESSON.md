# C06/ex02 — ft_rev_params

> **1337 / 42 Piscine** · Concepts: reverse argv  
...
Master **ft_rev_params** and build intuition for: **reverse argv**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_rev_params` | Appears again in exams and later modules |
...
Implement **ft_rev_params** following the 42 subject for C06/ex02.

**Key concepts:** reverse argv
...
**ft_rev_params** — reverse argv. Understand the model, then the syntax.
