# C06/ex03 — ft_sort_params

> **1337 / 42 Piscine** · Concepts: sort argv strings  
...
Master **ft_sort_params** and build intuition for: **sort argv strings**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_sort_params` | Appears again in exams and later modules |
...
- [C06/README.md](../README.md) module index
- Relevant **Theory/** lessons (see module README)
- Previous exercises in **C06**

---

## The Problem

Implement **ft_sort_params** following the 42 subject for C06/ex03.

**Key concepts:** sort argv strings
...
**ft_sort_params** — sort argv strings. Understand the model, then the syntax.
