...
> **1337 / 42 Piscine** · Concepts: malloc array  
...
Master **ft_range** and build intuition for: **malloc array**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_range` | Appears again in exams and later modules |
...
Implement **ft_range** following the 42 subject for C07/ex01.

**Key concepts:** malloc array
...
**ft_range** — malloc array. Understand the model, then the syntax.
