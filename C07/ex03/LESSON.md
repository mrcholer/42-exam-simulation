...
> **1337 / 42 Piscine** · Concepts: malloc, concat  
...
Master **ft_strjoin** and build intuition for: **malloc, concat**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_strjoin` | Appears again in exams and later modules |
...
Implement **ft_strjoin** following the 42 subject for C07/ex03.

**Key concepts:** malloc, concat
...
**ft_strjoin** — malloc, concat. Understand the model, then the syntax.
