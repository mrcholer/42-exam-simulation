# C07/ex04 — ft_convert_base

> **1337 / 42 Piscine** · Concepts: base conversion  
...
Master **ft_convert_base** and build intuition for: **base conversion**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_convert_base` | Appears again in exams and later modules |
...
Implement **ft_convert_base** following the 42 subject for C07/ex04.
...
**ft_convert_base** — base conversion. Understand the model, then the syntax.
