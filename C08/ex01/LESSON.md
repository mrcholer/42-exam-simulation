# C08/ex01 — Makefile basics

> **1337 / 42 Piscine** · Concepts: compilation rules  
...
Master **Makefile basics** and build intuition for: **compilation rules**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `makefile_basics` | Appears again in exams and later modules |
...
Implement **Makefile basics** following the 42 subject for C08/ex01.

**Key concepts:** compilation rules
...
| Item | Value |
|------|-------|
| Function | `makefile_basics` |
| Concepts | compilation rules |
...
**Makefile basics** — compilation rules. Understand the model, then the syntax.
