# C08/ex02 — Makefile advanced

> **1337 / 42 Piscine** · Concepts: variables, rules  
...
Master **Makefile advanced** and build intuition for: **variables, rules**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `makefile_advanced` | Appears again in exams and later modules |
...
Implement **Makefile advanced** following the 42 subject for C08/ex02.

**Key concepts:** variables, rules
...
| Item | Value |
|------|-------|
| Function | `makefile_advanced` |
| Concepts | variables, rules |
...
**Makefile advanced** — variables, rules. Understand the model, then the syntax.
