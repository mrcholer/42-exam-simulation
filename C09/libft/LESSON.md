# C09/libft — libft library

> **1337 / 42 Piscine** · Concepts: full C library project  
...
Master **libft library** and build intuition for: **full C library project**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `libft_library` | Appears again in exams and later modules |
...
- [C09/README.md](../README.md) module index
- Relevant **Theory/** lessons (see module README)
- Previous exercises in **C09**

---

## The Problem

Implement **libft library** following the 42 subject for C09/libft.

**Key concepts:** full C library project
...
├────────────┼─────────┼──────────────────────┤
│ (draw yours)│         │ full C library project │
└────────────┴─────────┴──────────────────────┘
```
...
| Item | Value |
|------|-------|
| Function | `libft_library` |
| Concepts | full C library project |
...
**libft library** — full C library project. Understand the model, then the syntax.
