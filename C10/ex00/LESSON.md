# C10/ex00 — ft_list_create_elem

> **1337 / 42 Piscine** · Concepts: linked list node  
...
Master **ft_list_create_elem** and build intuition for: **linked list node**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_list_create_elem` | Appears again in exams and later modules |
...
- [C10/README.md](../README.md) module index
- Relevant **Theory/** lessons (see module README)
- Previous exercises in **C10**

---

## The Problem

Implement **ft_list_create_elem** following the 42 subject for C10/ex00.

**Key concepts:** linked list node
...
**ft_list_create_elem** — linked list node. Understand the model, then the syntax.
