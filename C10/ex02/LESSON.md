# C10/ex02 — ft_list_size

> **1337 / 42 Piscine** · Concepts: list length  
...
Master **ft_list_size** and build intuition for: **list length**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_list_size` | Appears again in exams and later modules |
...
Implement **ft_list_size** following the 42 subject for C10/ex02.

**Key concepts:** list length
...
**ft_list_size** — list length. Understand the model, then the syntax.
