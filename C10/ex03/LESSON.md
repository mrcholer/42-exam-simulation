# C10/ex03 — ft_list_last

> **1337 / 42 Piscine** · Concepts: list tail  
...
Master **ft_list_last** and build intuition for: **list tail**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_list_last` | Appears again in exams and later modules |
...
Implement **ft_list_last** following the 42 subject for C10/ex03.

**Key concepts:** list tail
...
**ft_list_last** — list tail. Understand the model, then the syntax.
