...
/*                                                                            */
/* ************************************************************************** */
/* C10/ex03 — ft_list_last — EDUCATIONAL REFERENCE */
/* Concepts: list tail — STUDY, DO NOT SUBMIT */
...
/* Implement ft_list_last per 42 subject — skeleton below */
/* TODO: Replace with your logic after tracing memory on paper */

/*
 * ft_list_last — list tail
...
int main(void)
{
	write(1, "Demo: ft_list_last\n", 19);
	/* Call ft_list_last here after you understand the function above. */
	return (0);
}
