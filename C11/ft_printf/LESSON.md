# C11/ft_printf — ft_printf

> **1337 / 42 Piscine** · Concepts: variadic functions, format strings  
...
Master **ft_printf** and build intuition for: **variadic functions, format strings**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ft_printf` | Appears again in exams and later modules |
...
- [C11/README.md](../README.md) module index
- Relevant **Theory/** lessons (see module README)
- Previous exercises in **C11**

---

## The Problem

Implement **ft_printf** following the 42 subject for C11/ft_printf.

**Key concepts:** variadic functions, format strings
...
|------|-------|
| Function | `ft_printf` |
| Concepts | variadic functions, format strings |
...
**ft_printf** — variadic functions, format strings. Understand the model, then the syntax.
