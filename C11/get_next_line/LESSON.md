# C11/get_next_line — get_next_line

> **1337 / 42 Piscine** · Concepts: buffered read, static  
...
Master **get_next_line** and build intuition for: **buffered read, static**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `get_next_line` | Appears again in exams and later modules |
...
Implement **get_next_line** following the 42 subject for C11/get_next_line.

**Key concepts:** buffered read, static
...
**get_next_line** — buffered read, static. Understand the model, then the syntax.
