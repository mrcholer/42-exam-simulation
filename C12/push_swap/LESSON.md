# C12/push_swap — push_swap

> **1337 / 42 Piscine** · Concepts: sorting algorithms, stacks  
...
Master **push_swap** and build intuition for: **sorting algorithms, stacks**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `push_swap` | Appears again in exams and later modules |
...
- [C12/README.md](../README.md) module index
- Relevant **Theory/** lessons (see module README)
- Previous exercises in **C12**

---

## The Problem

Implement **push_swap** following the 42 subject for C12/push_swap.

**Key concepts:** sorting algorithms, stacks
...
|------|-------|
| Function | `push_swap` |
| Concepts | sorting algorithms, stacks |
...
**push_swap** — sorting algorithms, stacks. Understand the model, then the syntax.
