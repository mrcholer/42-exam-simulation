# C13/philosophers — philosophers

> **1337 / 42 Piscine** · Concepts: threads, mutexes, deadlock  
...
Master **philosophers** and build intuition for: **threads, mutexes, deadlock**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `philosophers` | Appears again in exams and later modules |
...
- [C13/README.md](../README.md) module index
- Relevant **Theory/** lessons (see module README)
- Previous exercises in **C13**

---

## The Problem

Implement **philosophers** following the 42 subject for C13/philosophers.

**Key concepts:** threads, mutexes, deadlock
...
| Concepts | threads, mutexes, deadlock |
...
**philosophers** — threads, mutexes, deadlock. Understand the model, then the syntax.
