# Exam/exam00 — Exam Week 0 prep

> **1337 / 42 Piscine** · Concepts: Shell + C00 level  
...
Master **Exam Week 0 prep** and build intuition for: **Shell + C00 level**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `exam_week_0_prep` | Appears again in exams and later modules |
...
Implement **Exam Week 0 prep** following the 42 subject for Exam/exam00.

**Key concepts:** Shell + C00 level
...
| Item | Value |
|------|-------|
| Function | `exam_week_0_prep` |
| Concepts | Shell + C00 level |
...
**Exam Week 0 prep** — Shell + C00 level. Understand the model, then the syntax.
