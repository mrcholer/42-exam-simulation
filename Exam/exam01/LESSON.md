# Exam/exam01 — Exam Week 1 prep

> **1337 / 42 Piscine** · Concepts: C01-C03 level  
...
Master **Exam Week 1 prep** and build intuition for: **C01-C03 level**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `exam_week_1_prep` | Appears again in exams and later modules |
...
Implement **Exam Week 1 prep** following the 42 subject for Exam/exam01.

**Key concepts:** C01-C03 level
...
| Item | Value |
|------|-------|
| Function | `exam_week_1_prep` |
| Concepts | C01-C03 level |
...
**Exam Week 1 prep** — C01-C03 level. Understand the model, then the syntax.
