...
/*                                                                            */
/* ************************************************************************** */
/* Exam/exam03 — Exam Week 3 prep — EDUCATIONAL REFERENCE */
/* Concepts: C07-C09 level — STUDY, DO NOT SUBMIT */
...
/* Implement exam_week_3_prep per 42 subject — skeleton below */
/* TODO: Replace with your logic after tracing memory on paper */

/*
 * exam_week_3_prep — C07-C09 level
...
int main(void)
{
	write(1, "Demo: Exam Week 3 prep\n", 23);
	/* Call exam_week_3_prep here after you understand the function above. */
	return (0);
}
