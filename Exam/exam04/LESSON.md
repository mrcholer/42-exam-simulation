# Exam/exam04 — Exam Week 4 prep

> **1337 / 42 Piscine** · Concepts: Full piscine review  
...
Master **Exam Week 4 prep** and build intuition for: **Full piscine review**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `exam_week_4_prep` | Appears again in exams and later modules |
...
Implement **Exam Week 4 prep** following the 42 subject for Exam/exam04.

**Key concepts:** Full piscine review
...
├────────────┼─────────┼──────────────────────┤
│ (draw yours)│         │ Full piscine review │
└────────────┴─────────┴──────────────────────┘
```
...
| Item | Value |
|------|-------|
| Function | `exam_week_4_prep` |
| Concepts | Full piscine review |
...
**Exam Week 4 prep** — Full piscine review. Understand the model, then the syntax.
