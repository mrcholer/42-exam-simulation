# Shell00/ex00 — Git repository setup

> **1337 / 42 Piscine** · Concepts: git, repository, clone, commit  
...
Master **Git repository setup** and build intuition for: **git, repository, clone, commit**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `git_repository_setup` | Appears again in exams and later modules |
...
- [Shell00/README.md](../README.md) module index
- Relevant **Theory/** lessons (see module README)
- Previous exercises in **Shell00**

---

## The Problem

Implement **Git repository setup** following the 42 subject for Shell00/ex00.

**Key concepts:** git, repository, clone, commit
...
| Item | Value |
|------|-------|
| Function | `git_repository_setup` |
| Concepts | git, repository, clone, commit |
...
**Git repository setup** — git, repository, clone, commit. Understand the model, then the syntax.
