# Shell00/ex01 — Identify your login

> **1337 / 42 Piscine** · Concepts: whoami, id, environment  
...
Master **Identify your login** and build intuition for: **whoami, id, environment**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `identify_your_login` | Appears again in exams and later modules |
...
Implement **Identify your login** following the 42 subject for Shell00/ex01.

**Key concepts:** whoami, id, environment
...
| Item | Value |
|------|-------|
| Function | `identify_your_login` |
| Concepts | whoami, id, environment |
...
**Identify your login** — whoami, id, environment. Understand the model, then the syntax.
