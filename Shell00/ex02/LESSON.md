# Shell00/ex02 — SSH and keys

> **1337 / 42 Piscine** · Concepts: ssh, public key, authentication  
...
Master **SSH and keys** and build intuition for: **ssh, public key, authentication**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `ssh_and_keys` | Appears again in exams and later modules |
...
Implement **SSH and keys** following the 42 subject for Shell00/ex02.

**Key concepts:** ssh, public key, authentication
...
| Item | Value |
|------|-------|
| Function | `ssh_and_keys` |
| Concepts | ssh, public key, authentication |
...
**SSH and keys** — ssh, public key, authentication. Understand the model, then the syntax.
