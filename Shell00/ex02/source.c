...
/*                                                                            */
/* ************************************************************************** */
/* Shell00/ex02 — SSH and keys — EDUCATIONAL REFERENCE */
/* Concepts: ssh, public key, authentication — STUDY, DO NOT SUBMIT */
/* Shell exercises: practice in terminal; this file is a study guide stub. */

#include <unistd.h>

/* STOP: List 3 shell commands you need for "SSH and keys" before reading main. */
/* THINK: What does each command read/write — stdout, files, or network? */

int main(void)
{
	write(1, "=== SSH and keys ===\n", 21);
	write(1, "Open LESSON.md and run commands in your terminal.\n", 50);
	write(1, "Concepts: ssh, public key, authentication\n", 42);
	return (0);
}
