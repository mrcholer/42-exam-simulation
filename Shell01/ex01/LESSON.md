# Shell01/ex01 — Print alphabet with Za/Zi

> **1337 / 42 Piscine** · Concepts: shell loops, echo  
...
Master **Print alphabet with Za/Zi** and build intuition for: **shell loops, echo**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `print_alphabet_with_za/zi` | Appears again in exams and later modules |
...
Implement **Print alphabet with Za/Zi** following the 42 subject for Shell01/ex01.

**Key concepts:** shell loops, echo
...
| Item | Value |
|------|-------|
| Function | `print_alphabet_with_za/zi` |
| Concepts | shell loops, echo |
...
**Print alphabet with Za/Zi** — shell loops, echo. Understand the model, then the syntax.
