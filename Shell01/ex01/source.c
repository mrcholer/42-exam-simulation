...
/*                                                                            */
/* ************************************************************************** */
/* Shell01/ex01 — Print alphabet with Za/Zi — EDUCATIONAL REFERENCE */
/* Concepts: shell loops, echo — STUDY, DO NOT SUBMIT */
/* Shell exercises: practice in terminal; this file is a study guide stub. */

#include <unistd.h>

/* STOP: List 3 shell commands you need for "Print alphabet with Za/Zi" before reading main. */
/* THINK: What does each command read/write — stdout, files, or network? */

int main(void)
{
	write(1, "=== Print alphabet with Za/Zi ===\n", 34);
	write(1, "Open LESSON.md and run commands in your terminal.\n", 50);
	write(1, "Concepts: shell loops, echo\n", 28);
	return (0);
}
