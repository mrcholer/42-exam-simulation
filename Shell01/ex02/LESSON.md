# Shell01/ex02 — Print 1024 times

> **1337 / 42 Piscine** · Concepts: loops, repetition  
...
Master **Print 1024 times** and build intuition for: **loops, repetition**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `print_1024_times` | Appears again in exams and later modules |
...
Implement **Print 1024 times** following the 42 subject for Shell01/ex02.

**Key concepts:** loops, repetition
...
**Print 1024 times** — loops, repetition. Understand the model, then the syntax.
