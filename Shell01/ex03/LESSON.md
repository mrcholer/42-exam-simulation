# Shell01/ex03 — Countdown

> **1337 / 42 Piscine** · Concepts: while loop, arithmetic  
...
Master **Countdown** and build intuition for: **while loop, arithmetic**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `countdown` | Appears again in exams and later modules |
...
Implement **Countdown** following the 42 subject for Shell01/ex03.

**Key concepts:** while loop, arithmetic
...
**Countdown** — while loop, arithmetic. Understand the model, then the syntax.
