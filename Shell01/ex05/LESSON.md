# Shell01/ex05 — MAC address

> **1337 / 42 Piscine** · Concepts: ifconfig, parsing  
...
Master **MAC address** and build intuition for: **ifconfig, parsing**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `mac_address` | Appears again in exams and later modules |
...
Implement **MAC address** following the 42 subject for Shell01/ex05.

**Key concepts:** ifconfig, parsing
...
**MAC address** — ifconfig, parsing. Understand the model, then the syntax.
