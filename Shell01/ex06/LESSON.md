# Shell01/ex06 — Group IDs

> **1337 / 42 Piscine** · Concepts: groups, id  
...
Master **Group IDs** and build intuition for: **groups, id**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `group_ids` | Appears again in exams and later modules |
...
Implement **Group IDs** following the 42 subject for Shell01/ex06.

**Key concepts:** groups, id
...
**Group IDs** — groups, id. Understand the model, then the syntax.
