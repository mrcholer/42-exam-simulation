# Shell01/ex07 — Find username

> **1337 / 42 Piscine** · Concepts: getent, passwd  
...
Master **Find username** and build intuition for: **getent, passwd**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `find_username` | Appears again in exams and later modules |
...
Implement **Find username** following the 42 subject for Shell01/ex07.

**Key concepts:** getent, passwd
...
**Find username** — getent, passwd. Understand the model, then the syntax.
