# Shell01/ex08 — Clean MAC script

> **1337 / 42 Piscine** · Concepts: sed, awk, scripting  
...
Master **Clean MAC script** and build intuition for: **sed, awk, scripting**.

| You will learn | Why it matters |
|----------------|----------------|
| Core pattern for `clean_mac_script` | Appears again in exams and later modules |
...
Implement **Clean MAC script** following the 42 subject for Shell01/ex08.

**Key concepts:** sed, awk, scripting
...
| Item | Value |
|------|-------|
| Function | `clean_mac_script` |
| Concepts | sed, awk, scripting |
...
**Clean MAC script** — sed, awk, scripting. Understand the model, then the syntax.
